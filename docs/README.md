...
| **Codex CLI** | ✅ Full support | JSONL | Core features implemented; some edge cases pending |
| **Gemini CLI** | ✅ Full support | JSON | All features implemented and tested |

See the format documentation for each agent for detailed implementation status.
...
| Document | Purpose |
|----------|---------|
| [competitive-analysis.md](competitive-analysis.md) | Survey of other conversation-history tools and how this project differs. |
