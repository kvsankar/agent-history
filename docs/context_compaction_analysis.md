# Context Compaction, Clearing, and Interruption Analysis

Analysis of how Claude Code, Codex CLI, and Gemini CLI handle context window compaction, summarization, explicit context clearing, and user/system interruptions.
