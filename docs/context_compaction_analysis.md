...
Analysis of how Claude Code, Codex CLI, and Gemini CLI handle context window compaction and summarization.
...
Claude Code:
  ...
  ~/.claude/projects/<workspace>/<session>/session-memory/summary.md
