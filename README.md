...
- **Markdown and offline HTML export** – Export whole workspaces or single sessions; Markdown minimal/flat/split modes; HTML writes a timeline `index.html` with linked turn-centered conversation detail pages.
