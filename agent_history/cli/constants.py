...
EXPORT_LAYOUT_TREE = "tree"
EXPORT_LAYOUT_SQUASHED = "squashed"
EXPORT_LAYOUT_FLAT = "flat"
EXPORT_LAYOUT_CHOICES = (EXPORT_LAYOUT_TREE, EXPORT_LAYOUT_SQUASHED, EXPORT_LAYOUT_FLAT)
EXPORT_LAYOUT_DEFAULT = EXPORT_LAYOUT_SQUASHED
